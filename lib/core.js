...
export const HOST_STRINGS = Object.freeze({
  zh:Object.freeze({
    ...
    native:Object.freeze({header:'Zeta 通知',defaultTitle:'DSH 通知',questionPrefix:'問題 ',custom:'其他／補充',submit:'送出回答',later:'稍後處理',submitted:'已送出，等待確認…',allowOnce:'僅允許這次',reject:'拒絕',close:'關閉',
      pleaseComplete:'請完成「',closingQuote:'」。',exclusive:'單選題請選擇選項或填寫其他，不能同時使用。',customTooLong:'補充文字不可超過 16000 字元。',lastError:'上次送出未通過：',tool:'工具：',reason:'原因：'}),
